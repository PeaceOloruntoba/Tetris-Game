...
public class Tetris extends JPanel implements Runnable {
    ...
    void drawUI(Graphics2D g) {
        ...
        JLabel Level, Score;
        Level = new JLabel("Level: " + scoreboard.getLevel());
        Level.setBounds(x, y + 30, 100, 30);
        Score = new JLabel("Score: " + scoreboard.getScore());
        Score.setBounds(x, y + 70 , 100, 30);
        add(Level);
        add(Score);
